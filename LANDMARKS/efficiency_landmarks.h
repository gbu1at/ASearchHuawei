...
#ifndef ASEARCH_EFFICIENCY_LANDMARKS_H
#define ASEARCH_EFFICIENCY_LANDMARKS_H
...
a_search_landmarks_average_efficiency_smart_lm(
        ...
        int cnt_landmarks = 1, int active_landmarks = 0, bool is_B_search = false);
...
#endif //ASEARCH_EFFICIENCY_LANDMARKS_H
